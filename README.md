...
├── sum10_model.pth         # 预训练CNN模型
├── core/                   # 核心模块
│   ├── gui.py             # 图形用户界面
│   ├── image_processor.py # 图像处理模块
│   ├── cnn_recognizer.py  # CNN数字识别器
│   ├── game_solver.py     # 游戏求解算法
│   └── automation.py      # 自动化操作控制
└── README.md              # 项目说明文档
```
...
感谢 [sum10_Nikke](https://github.com/Small-tailqwq/sum10_Nikke) 项目提供的核心算法和模型，本项目在此基础上进行了界面优化和功能扩展。